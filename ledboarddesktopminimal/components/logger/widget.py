...
from ledboarddesktopminimal.components.logger.logger import Logger
from ledboarddesktopminimal.components.logger.text_highlighter import TextHighlighter
